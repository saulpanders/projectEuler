...
# ex_011.py
# 
# Q: Find the largest product of 4 numbers in the 20x20 grid (horizontal, vertical, and diagonal)
# this answer reads like a clinic on good code, highly recommend
# https://codereview.stackexchange.com/questions/37767/largest-product-in-a-grid
grid = [
